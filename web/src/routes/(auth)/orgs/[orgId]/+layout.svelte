<script lang="ts">
	...
	import { Cog, House, User } from '@lucide/svelte';
		...
		<div class="flex grow">
			<Sidebar>
				{#snippet items(isExpanded)}
					<SidebarLink {isExpanded} href={URL_DASHBOARD} label="Members" Icon={User} />
                    <SidebarLink {isExpanded} href={URL_DASHBOARD} label="Org Settings" Icon={Cog} />
				{/snippet}
			</Sidebar>
